...
Recipes.List = {
    ["gmr_dsh_hogspub_fishnchips"] = {
        ...
        ingredients = {
            ["gmr_igd_poisson"] = {amount = 1},
            ["gmr_cpigd_frites"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_cpigd_bechamel"] = {amount = 1},  -- ingrédient intermédiaire
    ...
    ["gmr_dsh_hogspub_bubblensqueak"] = {
        ...
        ingredients = {
            ["gmr_cpigd_puree_de_pomme"] = {amount = 1},  -- ingrédient intermédiaire
    ...
    ["gmr_dsh_hogspub_chickenpie"] = {
        ...
        label = "Chiken pie",
        ingredients = {
            ["gmr_cpigd_pate_feuilletee"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_igd_poulet"] = {amount = 2},
            ["gmr_cpigd_sauce_bolognaise"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_igd_oeuf"] = {amount = 1},
            ["gmr_igd_sel"] = {amount = 1},
            ["gmr_igd_poivre"] = {amount = 1},
        },
    ...
    ["gmr_dsh_hogspub_bierraubeurre"] = {
        ...
        label = "Bierraubeure",
        ingredients = {
            ["gmr_igd_biere"] = {amount = 1},  -- nouvel ingrédient de base
            ["gmr_igd_beurre"] = {amount = 1},
            ["gmr_igd_sucre"] = {amount = 1},
    ...
    ["gmr_dsh_hogspub_polynectar"] = {
        ...
        label = "Polynectar",
        ingredients = {
            ["gmr_igd_herbes_magiques"] = {amount = 1},  -- nouvel ingrédient de base
    ...
    ["gmr_dsh_hogspub_jus_de_citrouille"] = {
        ...
        ingredients = {
            ["gmr_igd_citrouille"] = {amount = 2},  -- nouvel ingrédient de base
            ["gmr_igd_sucre"] = {amount = 1},
            ["gmr_igd_eau"] = {amount = 1},
        },
    },
    ...
    ["gmr_dsh_hogspub_felix_felicis"] = {
        ...
        ingredients = {
            ["gmr_igd_herbes_magiques"] = {amount = 1},  -- nouvel ingrédient
    ...
    ["gmr_dsh_hogspub_tartelette_citrouille"] = {
        ...
        ingredients = {
            ["gmr_cpigd_pate_sablee"] = {amount = 1},  -- ingrédient intermédiaire
    ...
    ["gmr_dsh_hogspub_bierraubeurre_glacee"] = {
        ...
        ingredients = {
            ["gmr_igd_biere"] = {amount = 1},  -- ingrédient de base
            ["gmr_igd_sucre"] = {amount = 1},
            ["gmr_igd_beurre"] = {amount = 1},
            ["gmr_cpigd_creme_fraiche"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_igd_vanille"] = {amount = 1},
    ...
    ["gmr_dsh_hogspub_soupe_chicaneur"] = {
        ...
        ingredients = {
            ["gmr_cpigd_fond_soupe"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_igd_poireau"] = {amount = 2},
            ["gmr_igd_carotte"] = {amount = 2},
            ["gmr_igd_pomme_de_terre"] = {amount = 2},
    ...
    ["gmr_dsh_hogspub_gateau_poudlard"] = {
        ...
        ingredients = {
            ...
            ["gmr_igd_oeuf"] = {amount = 3},
            ["gmr_igd_beurre"] = {amount = 2},
            ["gmr_igd_chocolat"] = {amount = 3},
            ["gmr_cpigd_coulis_fruit"] = {amount = 1},  -- ingrédient intermédiaire
        },
    },
    ["gmr_dsh_hogspub_the_sortilege"] = {
        ...
        ingredients = {
            ["gmr_igd_the"] = {amount = 1},  -- nouvel ingrédient
            ["gmr_igd_herbes_magiques"] = {amount = 1},
            ["gmr_igd_miel"] = {amount = 1},
            ["gmr_igd_eau"] = {amount = 1},
        },
    ...
    ["gmr_dsh_hogspub_tartelette_caramel_magique"] = {
        ...
        ingredients = {
            ["gmr_cpigd_pate_sablee"] = {amount = 1},  -- ingrédient intermédiaire
            ["gmr_cpigd_caramel_magique"] = {amount = 2},
            ["gmr_igd_sucre"] = {amount = 1},
            ["gmr_igd_cannelle"] = {amount = 1},
            ["gmr_igd_oeuf"] = {amount = 1},
        },
